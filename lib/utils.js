...
export const AGENTS_DIR = join(OPENCODE_CONFIG_DIR, 'agents');
export const LEARN_AGENT_PATH = join(AGENTS_DIR, 'learn.md');

// Default color for the Learn agent
export const DEFAULT_COLOR = '#14B8A6';

// Color options for interactive selection
...
// Model options for interactive selection
